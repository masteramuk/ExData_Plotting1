...
plot3 <- function(dir = ""){
    ...
    png(paste(getwd(),"/plot-png/plot3.png", sep =""), width=480, height=480)
    with(data_subset, plot(data_datetimecombine, Sub_metering_1, type="l", xlab="Day", ylab="Energy sub metering"))
